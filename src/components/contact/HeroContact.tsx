    ...
    <section className="relative py-20 lg:py-24 bg-cream dark:bg-night-bg transition-colors duration-300">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Institut Lymera — Contact Jacou"
          fill
      ...
      <div className="relative z-10 max-w-container mx-auto px-6 lg:px-0 flex flex-col items-center text-center">
        ...
        <h1 className="font-serif font-light text-dark dark:text-night-text leading-[1.1] mb-6
          ...
          Nous{" "}
          <em className="italic text-brown dark:text-night-accent">trouver</em>
        </h1>

        <p className="font-sans text-muted dark:text-night-text2 text-base leading-relaxed max-w-[520px]">
          À deux pas de Montpellier, à Jacou. Retrouvez toutes les informations pour nous contacter et réserver votre séance.
        </p>
